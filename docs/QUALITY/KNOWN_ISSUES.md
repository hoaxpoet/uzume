...
**Severity:** P2 · **Domain:** `dsp.mir` → `orchestrator` · **Failure class:** `pipeline-wiring` (the profile stores a saturated estimator while the trusted grid tempo sits beside it) · **Status:** Open, diagnosed 2026-09-26 · **Related:** OBS-DS4-1, BUG-076, D-073, D-075
