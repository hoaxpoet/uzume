...
**Severity:** P2 · **Domain:** `dsp.mir` → `orchestrator` · **Failure class:** not yet assigned (not diagnosed) · **Status:** Open, recorded while measuring BUG-143 · **Related:** OBS-DS4-1, BUG-076
