...
### BUG-132 — `beatPhase01` advances faster than its own installed grid tempo on some tracks (2026-09-14)

**Severity:** P2 · **Domain:** `dsp.beat` · **Failure class:** phase/rate drift · **Related:** BUG-065, parked at D-206
...
### BUG-133 — the grid's bar position cannot be confirmed to be the true musical downbeat (2026-09-14)
